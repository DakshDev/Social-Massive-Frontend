...
async function Header() {
  return (
    <header className="flex justify-center gap-4 p-5 bg-accent/50 rounded-sm relative">
      {/* Logo */}
      <div className="self-center relative size-fit flex justify-center items-center">
        <Image alt="profile pic" src="/avatar.jpg" height={100} width={100} className="size-35 object-cover object-center rounded-full border-2 border-border" />
